    ...
    var j = function(a) {
        ...
        g = function(z) {
            ...
            for (var q = 0; q < d.numPosts; q++) {
                ...
                if (A == 3) {
                    c += '<li class="related-post-item" tabindex="0"><a class="related-post-item-titleimg" href="' + v + '"' + b + ' title="' + t + '"><img alt="' + t + '" class="related-post-item-thumbnail" src="' + r + '" width="' + d.thumbWidth + '" height="' + d.thumbHeight + '" title="' + t + '"></a><div class="related-post-item-tooltip"><a class="related-post-item-title" title="' + t + '" href="' + v + '"' + b + ">" + w + "</a></div>" + y + "</li>"
                } else {
