    ...
    var j = function(a) {
      ...
      , g = function(z) {
        ...
        for (var q = 0; q < d.numPosts; q++) {
            ...
            if (A == 3) {
                c += '<li class="related-post-item" tabindex="0"><a class="related-post-item-titleimg" href="' + v + '"' + b + ' title="' + t + '"><img alt="' + t + '" class="related-post-item-thumbnail" src="' + r + '" width="' + d.thumbnailWidth + '" height="' + d.thumbnailHeight + '" title="' + t + '"></a><button class="bookmark-button" data-title="' + t + '" data-url="' + v + '">Loading...</button><h3 class="related-post-item-tooltip"><a class="related-post-item-title" title="' + t + '" href="' + v + '"' + b + ">" + w + "</a></h3>" + y + "</li>"
            } else {
